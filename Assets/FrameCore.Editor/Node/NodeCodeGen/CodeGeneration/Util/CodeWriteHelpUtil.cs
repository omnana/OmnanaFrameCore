...
namespace FrameCore.Editor
{
    ...
    public static class CodeWriteHelpUtil
    {
        ...
        {
            List<UnityEngine.Object>.Enumerator enumValues = objectCollector.values.GetEnumerator();
        ...
        public static void WriteFields(CodeWriter writer, ObjectCollector objectCollector)
        {
            ...
            {
                if (enumValues.Current == null) continue;
                UICodeGetter getter = CodeGetter(enumValues.Current);

                foreach (var code in getter.GetFieldCode(enumKeys.Current, enumValues.Current))
                {
        ...
        public static void WriteFields2(CodeWriter writer, ObjectCollector objectCollector)
        {
            ...
            while (enumKeys.MoveNext() && enumValues.MoveNext())
            {
                ...
                UICodeGetter getter = CodeGetter(enumValues.Current);
                foreach (var code in getter.GetFieldCode1(enumKeys.Current, enumValues.Current))
                {
                    writer.WriteLine(code);
                }
            }
        ...
        public static void WriteFields3(CodeWriter writer, ObjectCollector objectCollector)
        {
            ...
            while (enumKeys.MoveNext() && enumValues.MoveNext())
            {
                ...
                UICodeGetter getter = CodeGetter(enumValues.Current);
                foreach (var code in getter.GetFieldCode2(enumKeys.Current, enumValues.Current))
                {
                    writer.WriteLine(code);
                }
            }
        ...
        public static void WriteFields4(CodeWriter writer, ObjectCollector objectCollector)
        {
            ...
            while (enumKeys.MoveNext() && enumValues.MoveNext())
            {
                ...
                UICodeGetter getter = CodeGetter(enumValues.Current);
                foreach (var code in getter.GetFieldCode3(enumKeys.Current, enumValues.Current))
                {
                    writer.WriteLine(code);
                }
            }
        ...
        public static UICodeGetter CodeGetter(UnityEngine.Object ob)
        {
            ...
            //     {
            //         UICodeGetter UICodeGetter = Activator.CreateInstance(type, new object[] { go }) as UICodeGetter;
            //         return UICodeGetter;
            //     }
            // }
            return new NormalGetter(go);
        }
...
#pragma warning restore 0618
    public class NormalGetter : UICodeGetter
    {
        public NormalGetter(GameObject go) : base(go)
        {
        }
    }
}
