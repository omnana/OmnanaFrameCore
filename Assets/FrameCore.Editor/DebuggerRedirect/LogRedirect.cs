...
namespace FrameCore.Editor
{
    public class LogRedirect
    {
        ...
        public static bool OnOpenAsset(int instanceID, int line)
        {
            ...
            string[] buffer = trace.Split(new[] { FrameDebugger.logID + "\n" }, System.StringSplitOptions.None);

            if (buffer.Length < 2)
                return false;

            MonoScript monoScript = AssetDatabase.LoadAssetAtPath<MonoScript>("Assets/FrameCore/Util/Debugger/FrameDebugger.cs");
